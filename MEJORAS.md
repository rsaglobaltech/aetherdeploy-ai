...
Leyenda: 🔥 = bloqueante para producción · ⚡ = alto impacto · 🧩 = mejora estructural · 🎯 = diferenciador.
...
|--------|------|-------------|
| **S1 (2 sem)** | Estado y pipeline | 1.1 backend remoto · 1.2 checkpoint sqlite · 2.1 build/push imagen · 2.4 health checks |
| **S2 (2 sem)** | Seguridad y coste | 3.1 Infracost · 3.2 policy gates · 3.3 secrets · 7.1 keyring |
| **S3 (2 sem)** | Robustez | 2.2 migraciones · 2.3 rollback · 3.4 preflight cuotas · 2.5 destroy en grafo |
| **S4 (2 sem)** | Paridad cloud | 4.1 GCP/Azure tiers + catálogo · 4.3 CI/CD generado |
| **S5 (2 sem)** | Refactor + tests | 5.1 split monolitos · 5.2 state tipado · 5.3 cobertura 70 % |
| **S6 (2 sem)** | Diferenciadores | 3.5 drift detection · 4.6 dashboards obs · 6.5 modo chat persistente |
